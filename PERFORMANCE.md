...
- Commit: `f815d7b444422afd7159c873dbe7dfee4bcf30be`
...
| --- | ---: | ---: | ---: | ---: |
| `blas:xblat3d` | 1289.000 | 1290.000 | 1291.000 | -0.15% |
| `lapack:xlintstds` | 3510.000 | 3493.333 | 3509.000 | 0.03% |
...
xychart-beta
    ...
    x-axis ["2026-03-13", "2026-03-16", "2026-03-23", "2026-03-23", "2026-03-30", "2026-04-06", "2026-04-13", "2026-04-14", "2026-04-20", "2026-04-27"]
    y-axis "Median ms" 0 --> 1586
    line [1252, 1256, 1281, 1282, 1270, 1321, 1286, 1289, 1291, 1289]
```
...
xychart-beta
    ...
    line [3425, 3430, 3505, 3457, 3488, 3493, 3509, 3558, 3509, 3510]
```
