...
| --- | ---: | ---: | ---: | ---: |
| `blas:xblat3d` | 517.000 | 517.667 | 1289.000 | -59.89% |
| `lapack:xlintstds` | 3439.000 | 3456.000 | 3510.000 | -2.02% |
...
xychart-beta
    ...
    x-axis ["2026-03-13", "2026-03-16", "2026-03-23", "2026-03-23", "2026-03-30", "2026-04-06", "2026-04-13", "2026-04-14", "2026-04-20", "2026-04-27", "2026-05-04"]
    y-axis "Median ms" 0 --> 1586
    line [1252, 1256, 1281, 1282, 1270, 1321, 1286, 1289, 1291, 1289, 517]
```
...
xychart-beta
    ...
    line [3425, 3430, 3505, 3457, 3488, 3493, 3509, 3558, 3509, 3510, 3439]
```
...
| `2026-05-04` | `ef3d51bbd7a1e1da5df45a95e43c85a420bc9e58` | 517.000 | 3439.000 |
