...
| --- | ---: | ---: | ---: | ---: |
| `blas:xblat3d` | 514.000 | 529.667 | 1289.000 | -60.12% |
| `lapack:xlintstds` | 3530.000 | 3513.667 | 3510.000 | 0.57% |
...
xychart-beta
    ...
    x-axis ["2026-03-13", "2026-03-16", "2026-03-23", "2026-03-23", "2026-03-30", "2026-04-06", "2026-04-13", "2026-04-14", "2026-04-20", "2026-04-27", "2026-08-03"]
    y-axis "Median ms" 0 --> 1586
    line [1252, 1256, 1281, 1282, 1270, 1321, 1286, 1289, 1291, 1289, 514]
```
...
xychart-beta
    ...
    line [3425, 3430, 3505, 3457, 3488, 3493, 3509, 3558, 3509, 3510, 3530]
```
...
| `2026-08-03` | `ef3d51bbd7a1e1da5df45a95e43c85a420bc9e58` | 514.000 | 3530.000 |
