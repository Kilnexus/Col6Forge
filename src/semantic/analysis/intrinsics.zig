...
const IntrinsicArityMap = std.StaticStringMap(Arity).initComptime(.{
    ...
    .{ "FAILED_IMAGES", Arity{ .min = 0, .max = 2 } },
    .{ "IMAGE_STATUS", Arity{ .min = 1, .max = 2 } },
    .{ "STOPPED_IMAGES", Arity{ .min = 0, .max = 2 } },
    .{ "CLOG", Arity{ .min = 1, .max = 1 } },
    .{ "COUNT", Arity{ .min = 1, .max = 3 } },
    .{ "CSHIFT", Arity{ .min = 2, .max = 3 } },
    .{ "C_LOC", Arity{ .min = 1, .max = 1 } },
    .{ "CMPLX", Arity{ .min = 1, .max = 3 } },
    .{ "COMPLEX", Arity{ .min = 1, .max = 3 } },
    ...
    .{ "DOT_PRODUCT", Arity{ .min = 2, .max = 2 } },
    .{ "DSIGN", Arity{ .min = 2, .max = 2 } },
    .{ "DSHIFTL", Arity{ .min = 3, .max = 3 } },
    .{ "DSHIFTR", Arity{ .min = 3, .max = 3 } },
    ...
    .{ "EOSHIFT", Arity{ .min = 2, .max = 3 } },
    .{ "EXP", Arity{ .min = 1, .max = 1 } },
    .{ "EXTENDS_TYPE_OF", Arity{ .min = 2, .max = 2 } },
    .{ "ETIME", Arity{ .min = 1, .max = 2 } },
    .{ "FINDLOC", Arity{ .min = 2, .max = 5 } },
    ...
    .{ "IBCLR", Arity{ .min = 2, .max = 2 } },
    .{ "IBITS", Arity{ .min = 3, .max = 3 } },
    .{ "IBSET", Arity{ .min = 2, .max = 2 } },
    .{ "IAND", Arity{ .min = 2, .max = 2 } },
    .{ "IEOR", Arity{ .min = 2, .max = 2 } },
    .{ "IOR", Arity{ .min = 2, .max = 2 } },
    .{ "INT", Arity{ .min = 1, .max = 2 } },
    .{ "IS_CONTIGUOUS", Arity{ .min = 1, .max = 1 } },
    .{ "ISHFT", Arity{ .min = 2, .max = 2 } },
    .{ "ISHFTC", Arity{ .min = 2, .max = 3 } },
    ...
    .{ "COMMAND_ARGUMENT_COUNT", Arity{ .min = 0, .max = 0 } },
